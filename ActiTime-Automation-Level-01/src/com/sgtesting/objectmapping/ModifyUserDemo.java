...
public class ModifyUserDemo {
	...
	private static void modifyUser() {
		try {
			...
			Thread.sleep(2000);
			oBrowser.findElement(objmap.getLocator("firstName")).click();
			oBrowser.findElement(objmap.getLocator("firstName")).clear();
			oBrowser.findElement(objmap.getLocator("firstName")).sendKeys("DhanushPrince");
			oBrowser.findElement(objmap.getLocator("lastName")).click();
			oBrowser.findElement(objmap.getLocator("lastName")).clear();
			oBrowser.findElement(objmap.getLocator("lastName")).sendKeys("User11");
			oBrowser.findElement(objmap.getLocator("createUserCreateButton")).click();
			Thread.sleep(1000);
